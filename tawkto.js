(function(global) {
    global.$_Tawk_AccountKey = '5d42c04de5ae967ef80de39f';
    ...
    (function(global) {
        global.$_Tawk.widgetSettings = {
            ...
            "offlineForm": {
                ...
                "text": "Silakan isi formulir di bawah ini dan kami akan menghubungi kamu sesegera mungkin.",
                "fields": [{
                    "label": "Nama",
                    "isRequired": true,
                    "type": "name"
            ...
            "prechatForm": {
                "text": "Perkenalkan nama kamu dulu ya.",
                "fields": [{
                    "label": "Nama",
                    "isRequired": false,
                    "type": "name"
            ...
            "onlineGreeting": {
                "actionMessage": "Tulis pesanmu di sini",
                "shortMessage": "Online",
                "longMessage": "Hai, aku sedang Online. Silahkan chat secara langsung untuk mengirimkan pesan."
            },
            "awayGreeting": {
                "shortMessage": "Sibuk",
                "longMessage": "Maaf sedang sibuk, silahkan tunggu beberapa menit lagi."
            },
            "cf": null,
            "emoji": true,
            "uploads": true,
        ...
        ! function(u) {
            ...
            return function f(p, q, h) {
                ...
                5: [function(f, p, q) {
                    (function(h) {
                        ...
                        q.decode = function(m) {
                            ...
                            for (var v = new ArrayBuffer(l), R = new Uint8Array(v), l = 0; l < g; l += 4) p = h.indexOf(m[l]), b = h.indexOf(m[l + 1]), t = h.indexOf(m[l + 2]), q = h.indexOf(m[l + 3]), R[f++] = p << 2 | b >> 4, R[f++] = (b & 15) << 4 | t >> 2, R[f++] = (t & 3) << 6 | q & 63;
                            return v
                        }
                            ...
                            function g() {
                                ...
                                y || (q('probe transport "%s" opened', b), G.send([{
                                    ...
                                    G.once("packet", function(e) {
                                        y || ("pong" == e.type && "probe" == e.data ? (q('probe transport "%s" pong', b), x.upgrading = !0, x.emit("upgrading", G), G && (m.priorWebsocketSuccess = "websocket" == G.name, q('pausing current transport "%s"', x.transport.name), x.transport.pause(function() {
                                            ...
                                            e.transport = G.name, x.emit("upgradeError", e)))
                                    }))
                            }
                ...
                17: [function(f, p, q) {
                    ...
                    var V =
                        f("yeast"),
                        x = f("debug")("engine.io-client:polling");
                    p.exports = h;
                    ...
                    h.prototype.pause = function(b) {
                        ...
                        if (this.polling || !this.writable) {
                            var f = 0;
                            this.polling && (x("we are currently polling - waiting to pause"), f++, this.once("pollComplete", function() {
                                x("pre-pause polling complete");
                                --f || g()
                            }));
                            this.writable || (x("we are currently writing - waiting to pause"), f++, this.once("drain", function() {
    ...
    (function(u) {
        ...
        try {
            ...
            v.subscribable.fn = {
                subscribe: function(a, c, b) {
                    ...
                    var k = new v.subscription(this, a, function() {
                        v.utils.arrayRemoveItem(this._subscriptions[b],
                            k)
                    }.bind(this));
                ...
                getSubscriptionsCount: function() {
                    var a = 0;
                    v.utils.objectForEach(this._subscriptions,
                        function(c, b) {
                            a += b.length
                        });
                    return a
            ...
            (function(a) {
                ...
                function b(a) {
                    for (var c = [], d = 0, k = a.length, s, e; d < k;) s = a.charCodeAt(d++), 55296 <= s && 56319 >= s &&
                        d < k ? (e = a.charCodeAt(d++), 56320 == (e & 64512) ? c.push(((s & 1023) << 10) + (e & 1023) + 65536) : (c.push(s), d--)) : c.push(s);
                    return c
                }

                function k(a) {
                    var c, k, q, r, y, u, z, B, A, C = [],
                        D, Ca, Ba;
                    a = b(a);
                    D = a.length;
                    c = m;
                    k = 0;
                    y = l;
                    for (u = 0; u < D; ++u) A = a[u], 128 > A && C.push(x(A));
                    for ((q = r = C.length) && C.push(p); q < D;) {
                        z = s;
                        for (u = 0; u < D; ++u) A = a[u], A >= c && A < z && (z = A);
                        Ca = q + 1;
                        ...
                        for (u = 0; u < D; ++u) {
                            A = a[u];
                            if (A < c && ++k > s) throw new RangeError(t.overflow);
                            if (A == c) {
                                B = k;
                                for (z = e;; z += e) {
                                    A = z <= y ? f :
                                    ...
                                    Ba = B - A;
                                    B = e - A;
                                    C.push(x(A + Ba % B + 22 + 75 * (26 > A + Ba % B) - 0));
                                    B = w(Ba / B)
                                }
                                C.push(x(B + 22 + 75 * (26 > B) - 0));
                                y = Ca;
                                z = 0;
                                k = q == r ? w(k / n) : k >> 1;
                                for (k += w(k / y); k > v * g >> 1; z += e) k = w(k / v);
                                y = w(z + (v + 1) * k / (k + h));
                                k = 0;
                                ++q
                            }
            ...
            if ("function" !== typeof g.CustomEvent) {
                var S = function(a, c) {
                    ...
                    b.initCustomEvent(a,
                        c.bubbles, c.cancelable, c.detail);
                    return b
                };
            ...
            u.getWindowType = Tawk_API.getWindowType = function() {
                if (u.ready) return e.isEmbedded ? "embed" : e.isPopup ? "popup" : "inline"
            };
            ...
            var N = "",
                ...
                e = {
                    ...
                    isCenterPositioned: function() {
                        return "cr" ===
                            this.chatPosition() || "cl" === this.chatPosition()
                    },
            ...
            (function() {
                ...
                TawkClass.extend = function(b) {
                    ...
                    var e = new this;
                    a = !1;
                    for (var f in b) e[f] = "function" === typeof b[f] && "function" === typeof s[f] &&
                        c.test(b[f]) ? function(a, c) {
                            return function() {
                                var b = this._super;
                                this._super = s[a];
            ...
            B.prototype.generateRandomString =
                function(a) {
                    var c, b = [];
                    a = a || 6;
            ...
            B.prototype.togglePlaceholderText = function(a, c, d) {
            ...
            B.prototype.getGenericStyle = function(a) {
                return ["outline                     : " + (a.outline ? a.outline : "none") + " !important; ", "visibility                  : " + (a.visibility ? a.visibility : "visible") + " !important; ", "resize                      : " +
                    ...
                    (a.backgroundcolor ? a.backgroundcolor : "transparent") + " !important; ", "cursor                      : " + (a.cursor ? a.cursor : "auto") + " !important; ", "float                       : " + (a["float"] ? a["float"] : "none") + " !important; ", "border-radius               : " + (a.borderRadius ? a.borderRadius : "unset") + " !important; "
                ].join("").replace(/\s/gm, "")
            };
            ...
            B.prototype.transformGreetings = function(a) {
                for (var c = /\[([^)]+)\]/, b = /\(([^)]+)\)/, k = /\[[^\]\(\)]+\]\((\bhttp:\/\/\b|\bhttps:\/\/\b|\bmailto:\b){1}[^\]\(\)]+\)/i, s = "_blank", e = a, f, g; null !== (f = k.exec(e)) && (g = c.exec(f[0]), f =
                        b.exec(f[0]), f[0].indexOf("(mailto:") || (s = "_top"), e = e.replace(g[0] + f[0], '<a target="' + s + '" href="' + f[1] + '" class="link">' + g[1] + "</a>"), e !== a););
                return e
            };
            B.prototype.checkWhiteLabelLink = function(a, c, d) {
                var k = 1E4 * Math.random(),
                    s = this,
                    e = b.viewHandler.chatContainer,
                    f, g, h = null,
                    h = function() {
                        if (c.label !== a.innerHTML || c.url && c.url !== a.href || !c.url && a.href || c.id !== a.id || !e.getElementById(a.id) || c.cssText !== a.style.cssText) s.whiteLabelUnexpectedIssueLogged || (b.loggingHandler.logIncident("White label element has changed unexpectedly", {
                            pageId: D.uuid
                        }), s.whiteLabelUnexpectedIssueLogged = !0), a.id = c.id, a.innerHTML = c.label, a.style.cssText = c.cssText, null !== c.url ? a.href = c.url : a.removeAttribute("href"), !e.getElementById(c.parentElem.id) && c.grandParentName && (f = e.getElementById(c.grandParentName), c.siblingName && (g = e.getElementById(c.siblingName)) && f && f.insertBefore(c.parentElem, g)), f = e.getElementById(c.parentElem.id), !e.getElementById(a.id) && f && f.appendChild(a);
                        s.checkWhiteLabelLink(a, c, d)
                    };
                d ? this.messagePreviewCheckWhiteLabelRef = setTimeout(h,
                    k) : this.checkWhiteLabelRef = setTimeout(h, k)
            };
            ...
            B.prototype.getWebRTCToken = function(a, c, d) {
            ...
            B.prototype.updateFontStylesheet = function(a) {
                if (a && (a !== document || e.isPopup)) {
                    var c = a.getElementById("lato-fonts"),
                        b = a.body;
                    n.supportsLatin(e.locale) && !c ? (a.querySelector("head").innerHTML += '<link id="lato-fonts" rel="stylesheet" href="https://fonts.googleapis.com/css?family=Lato:100,100i,300,300i,400,400i,700,700i,900,900i&subset=latin-ext" rel="stylesheet"/>', this.addClass(b, "font-lato")) : !n.supportsLatin(e.locale) && c && (c.parentNode.removeChild(c), this.removeClass(b, "font-lato"))
                }
            };
            ...
            var bb = [{
                ...
                Ma = {
                    nokia: [/(NokiaBrowser)\/(\d+)\.(\d+).(\d+)\.(\d+)/, /^(Nokia)/, /(NokiaBrowser)\/(\d+)\.(\d+).(\d+)/, /(NokiaBrowser)\/(\d+)\.(\d+)/,
                        /(BrowserNG)\/(\d+)\.(\d+).(\d+)/, /(Series60)\/5\.0/, /(Series60)\/(\d+)\.(\d+)/, /(S40OviBrowser)\/(\d+)\.(\d+)\.(\d+)\.(\d+)/, /(Nokia)[EN]?(\d+)/
                    ],
                    ...
                    uc: [/(UCBrowser)[ \/](\d+)\.(\d+)\.(\d+)/, /(UC Browser)[ \/](\d+)\.(\d+)\.(\d+)/,
                        /(UC Browser|UCBrowser|UCWEB)(\d+)\.(\d+)\.(\d+)/
                    ],
                    "android2.3": [/(Android) 2\.3(?:[.\-]([a-z0-9]+))?/],
                    android2: [/(Android) 2\.(\d+)(?:[.\-]([a-z0-9]+))?/],
                    android: [/Android[\- ][\d]+\.[\d]+; [A-Za-z]{2}\-[A-Za-z]{0,2}; WOWMobile (.+) Build/, /Android[\- ][\d]+\.[\d]+\-update1; [A-Za-z]{2}\-[A-Za-z]{0,2}; (.+) Build/, /Android[\- ][\d]+\.[\d]+\.[\d]+; [A-Za-z]{2}\-[A-Za-z]{0,2}; (.+) Build/, /Android[\- ][\d]+\.[\d]+\.[\d]+;[A-Za-z]{2}\-[A-Za-z]{0,2};(.+) Build/, /Android[\- ][\d]+\.[\d]+; [A-Za-z]{2}\-[A-Za-z]{0,2}; (.+) Build/,
                        /Android[\- ][\d]+\.[\d]+\.[\d]+; (.+) Build/, /Android[\- ][\d]+\.[\d]+; (.+) Build/
                    ]
                },
                ca = function() {
            ...
            ca.prototype.getBrowserVersion =
                function() {
            ...
            ca.prototype.searchString = function(a) {
                ...
                for (b = 0; b < a.length; b++)
                    if (d = a[b].string, k = RegExp(a[b].subString),
                        this.versionSearchString = a[b].versionSearch || a[b].identity, k.test(d)) return a[b].identity
            };
            ...
            ca.prototype.getQuerystring = function(a, b) {
                ...
                b = b.replace(/[\[]/, "\\[").replace(/[\]]/, "\\]");
                d = RegExp("[\\?&]" + b + "=([^&#]*)").exec(a);
                return null === d || !n.isArray(d) || 2 > d.length ? null : d[1] ? unescape(d[1].replace(/\+/g,
                    " ")) : null
            };
            ...
            wa.prototype.log = function(a, b) {
                var d;
                b && a && (b.uiVersion = "v3", b.buildVersion = "677", b.buildCommit = "9148342a9c552b71d8097229f77de9d4b31e4f52", d = {
                    type: a,
                    data: b
            ...
            ka.prototype.listen = function(a, b, d, k) {
                ...
                if (k) {
                    ...
                    else if (document.attachEvent) d =
                        this.attachEvent(a, b, d);
                    else return null;
                    this.events[k] = {
                        element: a,
                        eventName: b,
            ...
            ka.prototype.getEvent = function(a) {
                var b = a || g.event;
                if (!b)
                    for (a = this.getEvent.caller; a && (!(b = a.arguments[0]) || Event != b.constructor);) a =
                        a.caller;
                return b
            };
            ...
            var ea = new P,
                ...
                fb = function(a, b, d) {
                    ...
                    this.loadBuffer = function() {
                        ...
                        a.onload = function() {
                            b.audioPlayer.audioContext.decodeAudioData(a.response,
                                function(a) {
            ...
            Qa.prototype.initAudioPlayer = function() {
                var a, c, d, k = {},
                    s = this;
                if (da.supported) {
                    this.audioContext || (/Firefox/.test(x.userAgent) ||
                        "undefined" === typeof AudioBuffer || void 0 === g.AudioContext && void 0 === g.webkitAudioContext) || (g.AudioContext = g.AudioContext || g.webkitAudioContext, this.audioContext = new g.AudioContext);
                    ...
                    this.audioContext && (d = function() {
                        s.isReadyForInit && (s.eventUsedForInit && !s.touchstartInited) && (s.sounds[s.eventUsedForInit].volume = 0, s.sounds[s.eventUsedForInit].play(), s.sounds[s.eventUsedForInit].source.stop(0),
                            s.sounds[s.eventUsedForInit].volume = 1, g && "function" === typeof g.removeEventListener && g.removeEventListener("touchstart", d, !1), c && "function" === typeof c.removeEventListener && c.removeEventListener("touchstart", d, !1), s.touchstartInited = !0)
                    }, y && "ontouchstart" in g && (a = b.viewHandler.chatContainer.elementReferrer, e.isPopup || (c = a.contentWindow ? a.contentWindow : a.contentDocument.defaultView), c ? c.addEventListener("touchstart", d, !1) : a.addEventListener("touchstart", d, !1), g.addEventListener("touchstart", d, !1)))
                }
            };
            ...
            var Ra = function() {
                ...
                b.eventEmitter.on("fileUploadError", function(c) {
                    ...
                    d && b.viewHandler.handleUploadError(null,
                        d, c.handle)
                })
            };
            ...
            var Da, H, xa, Ea, ta = 0,
                ...
                Xa = function() {
                    for (var a = n.getElementsByClassName(Da, "emoji-select"), c = 0; c < a.length; c++) b.eventHandler.listen(a[c], b.viewHandler.clickEvent, function(a) {
                        ...
                        y && e.isPopup ? b.viewHandler.addEmojiToInput(a) :
                            "max" === r.chatWindowState() || e.isPopup ? f.addEmojiToInput(a) : b.viewHandler.messagePreview && b.viewHandler.messagePreview.addEmojiToInput(a)
                    }, a[c].id + "SelectEmoji")
                },
                ua = function() {
            ...
            ua.prototype.init = function() {
                ...
                a = {
                    ...
                    ust: $_Tawk_Unstable,
                    p: e.isPopup ? L.pageName() : document.title,
                    r: document.referrer
                };
                ...
                this.socket.on("error", function(a) {
                    ...
                    if (a instanceof Error) {
                        ...
                        "TransportError" === a.type && (d.description = a.description); - 1 !== d.toString.indexOf("post") && (e = "socket post error")
                    } else d = a;
                    b.loggingHandler.logIncident(e,
                        d);
                    c.socket.disconnect();
                    c.disconnectHandler()
                });
            ...
            ua.prototype.addEventListeners = function() {
                function a(a, c) {
                    try {
                        ...
                        q.handleError("Unable to emit socket event : " + a + " with data : " + JSON.stringify(c), e.fileName,
            ...
            ha.prototype.addPlaceholderHandler = function() {
                ...
                ga || (a = this.formData.fields) && a.forEach(function(a) {
                    ...
                    "input" !== a.type || a.isEnabled && !a.isEnabled() || (f = a.getValue ? a.getValue() : "", "input" === a.type && n.isArray(f) ? f.forEach(function(b, f) {
                        ...
                        e = b;
                        n.togglePlaceholderText(k, e, a.fieldName +
                            f);
                        "textarea" !== k.tagName.toLowerCase() || n.trim(k.value) || (k.value = e)
                    }) : a.hiddenIE8 || (k = c.documentRef.getElementById(a.fieldName + "Field"), e = b.languageParser.translate("form", a.languageKey + "Placeholder"), n.togglePlaceholderText(k, e, a.fieldName + "Field"), "textarea" !== k.tagName.toLowerCase() || n.trim(k.value) || (k.value = e)))
                })
            };
                ...
                function() {
                    ...
                    if (null === this.formData.dynamicFields) {
                        for (var d = 0, k = e[a + "Options"].fields.length; d < k; d++) {
                            ...
                            "name" === f.type ? (s.valueMaxLength = 40, s.getValue = b.visitorHandler.getNameValue, s.languageKey = "Name") :
                                "email" === f.type ? (s.valueMaxLength = 150, s.getValue = b.visitorHandler.getEmailValue, s.validation = "isValidEmail", s.languageKey = "Email") : "message" === f.type || "textArea" === f.type ? s.valueMaxLength = 500 : "inputText" === f.type ? s.valueMaxLength = 150 : "department" === f.type ? s.getValue = b.sessionHandler.getDeparmentOptions : "choice" === f.type || "option" === f.type ? (s.type = "options", s.selections = f.selections) : "phone" === f.type && (s.valueMaxLength = 20, s.validation = "isValidPhone", s.languageKey = "Phone");
            ...
            Y.prototype.generateDynamicFields = function() {
                for (var a = "", b = RegExp("__LABEL__", "gm"), d = RegExp("__ID__", "gm"), k = RegExp("__MAXLENGTH__", "gm"), e = 0, f = this.formData.dynamicFields.length; e < f; e++) {
                    var g, h = "",
            ...
            Y.prototype.generateDropDownOptions = function(a, c, d) {
                ...
                "preChatForm" === this.formData.id ? k += '<option id="department-default" value="" disabled selected>' +
            ...
            var oa = function(a) {
                ...
                this.pageTitleNotification = {
                    ...
                    on: function() {
                        !this.interval &&
                            e.showUnreadInTab() && (this.interval = setInterval(function() {
            ...
            oa.prototype.show = function() {
                ...
                if (!("max" === r.chatWindowState() &&
                        !e.isPopup || this.isPopupFocused && !b.viewHandler.popoutWin.closed || e.hideWidgetOnLoad || "restartChatForm" === b.formHandler.currentForm || "offlineForm" === b.formHandler.currentForm) && this.container && this.container.elementReferrer) {
            ...
            E.prototype.init = function() {
                this.container && (this.wrapper || (this.wrapper = this.container.getElementById("tawkchat-message-preview-container"), e.isRTL() && (this.wrapper.className +=
            ...
            var z = TawkClass.extend({
                ...
                updateViewByStatus: function(a) {
                    ...
                    "online" === a || "away" === a ? (e.showConsentForm ? b.formHandler.openForm("consentForm") : e.showPreChatForm && !r.prechatFormSubmitted() && b.formHandler.openForm("preChatForm"), this.showWidget(), p && (b.viewHandler.isMaximized || p.showBubble(), p.toggleOfflineIcon(!1))) : "offline" === a && (e.hideWidgetOnOffline ? this.hideWidget() : (b.formHandler.openForm(e.showConsentForm ? "consentForm" : "offlineForm"), this.showWidget()), p && (p.hideBubble(), p.toggleOfflineIcon(!0), this.messagePreview && this.messagePreview.removeAllElements()))
                }
            });
            ...
            z.prototype.setDivider = function(a, c, d) {
                ...
                !this.chatContainer.documentRef.getElementById("newMessageDivider") && (g = this.chatContainer.documentRef.getElementById("chatWrapper"), f = new C("newMessageDivider"), f.template = n.escapeTemplateReplacement(c, [{
                    ...
                    }]), f.buildView(), g.insertBefore(f.elementReferrer, d.elementReferrer),
                    !n.chatElementInView(f.elementReferrer) && (b.viewHandler.isMaximized || e.isPopup || e.isEmbedded) && (k = this.chatContainer.documentRef.getElementById("newMessagesBar"))) && (k.className = "visible", b.eventHandler.listen(k, this.clickEvent, function() {
            ...
            var K = TawkClass.extend({
                ...
                buildView: function() {
                    var a;
                    if (this.container && (b.MinifiedStyle = b.MinifiedStyle.replace(/#tawktoLink/g, "#" + b.viewHandler.tawktoLinkName), b.MinifiedStyle = b.MinifiedStyle.replace(/#bottomContainer/g, "#" + b.viewHandler.bottomContainerName), e.showMessagePreview() ? this.initMessagePreviewContainer() : this.destroyMessagePreviewContainer(), this.chatIndicator.buildIframe(b.MinifiedStyle + e.minStyle()), a = n.getElementsByTagName(this.chatIndicator.documentRef, "body")[0], a.innerHTML =
                            t["tawkchat-chat-indicator"], this.container.buildIframe(b.MinifiedStyle + e.minStyle()), this.bubbleContainer && (e.chatBubble() && this.bubbleContainer.elementReferrer ? this.bubbleContainer.buildIframe(b.MinifiedStyle + e.minStyle()) : this.bubbleContainer.clear()), this.widgetDimensionsUpdated(), this.updateGreetings(), this.attachEvents(), this.inDocument = !0, e.isDesktopRectangle())) {
            ...
            K.prototype.bubbleSettingsChanged = function() {
                ...
                b && (b.viewHandler && b.viewHandler.iframeContainer && b.viewHandler.iframeContainer.elementReferrer) && (a && (a.type && "default" !== a.type || this.bubbleContainer.elementReferrer &&
                    this.bubbleContainer.insertCssFile(".bubble-text-color{color:" + (e.chatBubble() ? e.chatBubble().fgc : "#ffffff") + ";}", !0), a && (this.bubbleContainer || (this.bubbleContainer = new Q(n.getRandomName(), n.getGenericStyle({
                        ...
                        !0), this.bubbleContainer.buildIframe(b.MinifiedStyle + e.minStyle())))), this.createBubble(), this.attachBubbleEvents())
            };
            ...
            K.prototype.calculateBubblePositioning = function(a, b, d, k, f, g, h) {
            ...
            K.prototype.agentBarChanged = function(a) {
                ...
                e.hideWidget || (this.container.massRestyle({
                    ...
                    }), h = T && 10 > O, closeIconWidth = 16, minWidth = e.minimizedDimensions().width, minHeight = e.minimizedDimensions().height, b = e.chatBubble(), d = a - minHeight, l = b.rotate, b.type && "default" !== b.type ? (k = b.topOffset, f = b.bottomOffset, bubbleWidth = b.width, bubbleContainerHeight = b.height + closeIconWidth, g = e.isRightPositioned() ?
            ...
            K.prototype.toggleOfflineIcon = function(a) {
                var b, d;
                this.container && !e.isDesktopRectangle() && (b = this.container.getElementById("maximizeChat")) && (a ? (a = "icon-chat", d = "icon-mail") : (a = "icon-mail", d = "icon-chat"), n.removeClass(b, a), n.addClass(b, d))
            };
            ...
            var Fa = K.extend({
                ...
                createCanvasChatBubble: function() {
                    var a, b, d,
                        k, f, g, h, l, m, n, p, q, r, t, v, x, u, w = 5,
                        y = e.chatBubble().bgc;
                    if (a = this.bubbleContainer.getElementById("tawkchat-chat-bubble-canvas")) e.chatPosition(), a.width = "146", a.height = "85", f = a.getContext("2d"), f.clearRect(0, 0, 134, 63), f.fillStyle = y, e.isTopPositioned() ? (w = 16, g = 68, r = w + 3, q = 81, t = 6, v = !1, a = 1.1, b = 1.9, d = 1.6, k = 0.85) : (g = w = 6, r = w + 63 - 3, q = 55, t = 79, v = !0, a = 0.9, b = 0.1, d = 0.4, k = 1.15), e.isRTL() ? (u = 10, closeContainerStart = u - 4, h = u + 2, l = u + 5, m = u - 2, n = u - 2, p = u + 5, q = 81, e.isTopPositioned() ? (x = v, d = 0.2, k = 1.45) : (x = !v, d = 0.6, k = 1.85)) : (u =
                            2, closeContainerStart = u + 134 + 4, h = u + 134 - 2, l = u + 134 - 5, m = u + 134 + 2, n = u + 134 + 2, p = u + 134 - 5, x = v), f.beginPath(), f.moveTo(u + 8, w), f.lineTo(68, w), f.lineTo(u + 134 - 8, w), f.quadraticCurveTo(u + 134, w, u + 134, w + 8), f.lineTo(u + 134, w + 63 - 8), f.quadraticCurveTo(u + 134, w + 63, u + 134 - 8, w + 63), f.lineTo(u + 8, w + 63), f.quadraticCurveTo(u, w + 63, u, w + 63 - 8), f.lineTo(u, w + 8), f.quadraticCurveTo(u, w, u + 8, w), f.strokeStyle = "#e3e0e7", f.lineWidth = 2, f.stroke(), f.closePath(), f.fill(), f.beginPath(), f.arc(68, r, 10, Math.PI * a, Math.PI * b, v), f.strokeStyle = "#e3e0e7",
                        f.lineWidth = 2, f.stroke(), f.fill(), e.isDesktopRectangle() || (e.isTopPositioned() && e.isLeftPositioned() ? q -= 30 : e.isBottomPositioned() && e.isRightPositioned() ? q += 30 : e.isCenterPositioned() && e.isRightPositioned() && (q += 30)), f.beginPath(), f.arc(q, t, 5, 0, 2 * Math.PI, !1), f.strokeStyle = "#e3e0e7", f.lineWidth = 2, f.stroke(), f.closePath(), f.fill(), f.beginPath(), f.arc(h, g + 5, 10, Math.PI * d, Math.PI * k, x), f.strokeStyle = "#e3e0e7", f.lineWidth = 2, f.stroke(), f.closePath(), f.fillStyle = y, f.fill(), f.beginPath(), f.moveTo(l, g + 1.5), f.lineTo(m,
                            g + 8), f.closePath(), f.lineWidth = 2, f.strokeStyle = e.chatBubble().fgc, f.stroke(), f.beginPath(), f.moveTo(n, g + 1.5), f.lineTo(p, g + 8), f.closePath(), f.lineWidth = 2, f.strokeStyle = e.chatBubble().fgc, f.stroke()
                }
            });
            ...
            Fa.prototype.addClassName = function() {
                ...
                this.container && this.container.elementReferrer && (this.container.getElementById("tawkchat-minified-wrapper").className =
                    n.getContrast(e.headerTxtColor) + a);
            ...
            var W = TawkClass.extend({
                init: function(a, c) {
                    ...
                    this.resizeThrottle = 0;
                    this.container =
                        e.isPopup ? new C(n.getRandomName(), "display: none;") : new Q(n.getRandomName(), n.getGenericStyle({
                            zindex: "999999",
                            position: "static",
                            display: "none",
                            height: this.frameHeight,
                    ...
                    e.maximizedDimensions.subscribe(function(a) {
                        e.isEmbedded || (e.isPopup || y) || (d.frameHeight = a.height + "px", d.frameWidth = a.width + "px", d.container.restyle("height", d.frameHeight + " !important"), d.container.restyle("width",
                    ...
                    e.desktopWidget.subscribe(function() {
                        e.isDesktopRectangle() ? (d.wrapper.removeClass("roundWidget"), d.container.documentRef.getElementById("minimizeChat").className = "headerBoxLink", "br" === e.chatPosition() ? d.container.documentRef.body.className = "right" : d.container.documentRef.body.className = "left") : (d.wrapper.addClass("roundWidget"), d.container.documentRef.getElementById("minimizeChat").className = "notShown")
                    });
                ...
                buildView: function() {
                    ...
                    e.isEmbedded || e.isPopup || y ? this.restyleEmbed() : "br" == e.chatPosition() ? (n.removeClass(this.container.documentRef.body, "left"), n.addClass(this.container.documentRef.body, "right")) : (n.removeClass(this.container.documentRef.body,
                ...
                toggleEmojiAction: function() {
                    ...
                    e.showEmoji() ? (f.innerHTML = t.loader,
                ...
                attachEvents: function() {
                    ...
                    this.container.attachUserEventListener(b.viewHandler.clickEvent, function(c) {
                        e.isPopup ? g.close() : (b.eventHandler.cancelEvent(c),
                    ...
                    if (y) {
                        ...
                        f && (db.initElement(f, function(d, e) {
                        ...
                        function(d) {
                            ...
                            setTimeout(function() {
                                e.value ? (f.style.display = "none", k.className = k.className.replace("additionalPadding", ""), n.removeClass(k, "additionalPadding")) : (f.style.display = "block",
                ...
                toggleSound: function() {
                    ...
                    a && b && (e.soundOn() ? (a.style.display = "block", b.style.display = "none") : (a.style.display = "none", b.style.display = "block"))
                }
            });
            ...
            W.prototype.restyleEmbed = function() {
                ...
                e.isPopup && (this.wrapper.addClass("popout"),
            ...
            W.prototype.updateGreetings = function(a) {
                ...
                if (this.container.elementReferrer) {
                    ...
                    if (a = a || r.pageStatus()) c = this.container.getElementById("shortMessage"), this.setChatGreetings(), c && this.chatTextarea && (a = m.getShortMessage(a), null !== a && (c.innerHTML =
                        a, e.onlineGreeting && (a = n.rawDecode(e.onlineGreeting.actionMessage), ga ? this.chatTextarea.elementReferrer.placeholder = a : (this.chatTextarea.elementReferrer.value = a, n.togglePlaceholderText(this.chatTextarea.elementReferrer, a, "chatTextarea")))))
                }
            };
            ...
            W.prototype.resizeTextArea = function() {
                ...
                this.resizeThrottle = setTimeout(function() {
                    ...
                    c && n >= h ? (n = 150 < n ? 150 : n, this.isActionsContainerNotifShown && (n += 42, d.style.paddingBottom = "42px"), e.style.height = 46 + (n - h) + "px", g && b.viewHandler.scrollToBottom()) : e.style.height = "46px";
            ...
            var F = z.extend({
                init: function() {
                    ...
                    if (!e.isPopup &&
                        !e.isEmbedded) {
                        p = new Fa;
                        var b = [p.container, p.chatIndicator, p.bubbleContainer, this.overlayElement],
                            d;
                        ...
                        this.iframeContainer.addChildViews(b.concat(d))
                    }
                ...
                insertFrameStyle: function() {
                    ...
                    e.isTopPositioned() ? (a = "transform:translate(0, -30px);", b = "transform:translate(0, 0px);") : e.isCenterPositioned() ? (a = e.isRightPositioned() ? "transform:translate(30px,0);" : "transform:translate(-30px,0);", b = "transform:translate(0px,0);") : (a = "transform:translate(0, 30px);", b = "transform:translate(0, 0px);");
                    a = "{0%{opacity:0;" + a + ";}to{opacity:1;" + b + "}}";
                    k = k + ("@keyframes tawkMaxOpen" +
                        a) + ("@-moz-keyframes tawkMaxOpen" + a);
                ...
                show: function() {
                    f.hide();
                    e.isEmbedded || e.isPopup ? (this.iframeContainer.restyle("position", "static"), this.iframeContainer.restyle("right", ""), this.iframeContainer.restyle("left", ""), this.iframeContainer.restyle("width", "100%"), this.iframeContainer.restyle("height",
                        "100%"), f.show()) : (this.isWidgetPositionsUpdated = !0, this.indicator.initIndicator(), b.main.maximize ? this.maximizeWidget() : this.minimizeWidget());
                    this.updateViewByStatus(r.pageStatus());
                    this._super()
                }
            });
            F.prototype.calculateWidgetPosition = function() {
                var a, b, d = Math.max((document.documentElement.clientHeight, g.innerHeight || 0) / 2) - e.maximizedDimensions().height / 2,
                    f = {};
                e.isDesktopRectangle() ? (a = 0, b = e.widgetOffsetX) : (b = 10, a = e.minimizedDimensions().height + e.widgetOffsetX + 10, b = e.isCenterPositioned() ? e.minimizedDimensions().width +
                    e.widgetOffsetX + b : b);
            ...
            F.prototype.maximizeWidget = function() {
                ...
                f.show();
                p && p.container && (e.isDesktopRectangle() ? p.hide() : (p.shown || p.show(), a && c && (n.removeClass(c, "appear"), n.addClass(c, "hide"), n.removeClass(a, "hide"), n.addClass(a, "appear")), p.hideBubble(), n.addClass(p.container.getElementById("tawkchat-minified-box"), "open")));
                this.isMaximized = !0;
            ...
            F.prototype.popoutWidget = function() {
                var a =
                    "https://tawk.to/chat/" + L.pageId + "/";
                this.indicator.hide();
                r.chatWindowState("min");
                this.popoutWin && !this.popoutWin.closed && this.popoutWin.focus ? this.popoutWin.focus() : (e.whiteLabel() && e.whiteLabel().chatUrl && (a = e.whiteLabel().chatUrl + "/chat/"), this.popoutWin = g.open(a + $_Tawk_WidgetId + "?$_tawk_sk=" + r.sessionKey + "&$_tawk_tk=" + r.transferKey + "&v=" + r.serverVersion, "Tawk", "height=500, width=450, resizable=yes, toolbar=no, location=no, menubar=no, personalbar=no"))
            };
            ...
            F.prototype.insertPopupStyle = function() {
                ...
                d.styleSheet ?
                    d.styleSheet.cssText = f.nodeValue : d.appendChild(f);
                c.appendChild(d);
                a.appendChild(c);
            ...
            F.prototype.begin = function() {
                var a = this,
                    ...
                    d;
                b.main.started || (this.iframeContainer && (d = document.getElementById(this.iframeContainer.elementId)), d && d.parentNode.removeChild(d), e.isEmbedded && c ? (c.appendChild(this.iframeContainer.elementReferrer), b.eventHandler.listen(g, "resize", function() {
                    a.onEmbeddedWindowResize()
                }, "windowresize")) : (document.body.appendChild(this.iframeContainer.elementReferrer),
                    e.isPopup ? this.insertPopupStyle() : (p.buildView(), this.resizeFromLeft.attachUserEventListener("mousedown", function(b) {
                    ...
                    }, null, "resizeBottomLeftfocus"), this.resizeBottomRight.attachUserEventListener("mousedown",
                        function(b) {
            ...
            F.prototype.onHeaderMouseDown = function(a, c, d) {
                ...
                h.id !== this.resizeFromLeft.elementId && h.id !== this.resizeFromRight.elementId && h.id !== this.resizeFromTop.elementId && h.id !== this.resizeFromBottom.elementId && h.id !== this.resizeTopLeft.elementId &&
                    h.id !== this.resizeBottomLeft.elementId && h.id !== this.resizeTopRight.elementId && h.id !== this.resizeBottomRight.elementId || (1 === a.button && !g.event && !f.documentRef.event || 1 < a.button) || (b.eventHandler.cancelEvent(a), this.overlayElement.restyle("display", "block !important"), a = this.getActualViewportDimensions(), this.actualViewPortWidth = a.width, this.actualViewPortHeight = a.height, this.startOffsetY = this.startOffsetX = 0, this.mouseMovehandler = b.eventHandler.listen(document, "mousemove", function(a) {
                        e.setResizedDimensions(a,
                            c, d);
                        e.isResized = !0;
                        e.redrawIE()
            ...
            F.prototype.setResizedDimensions = function(a, c, d) {
                ...
                this.isRight && "undefined" !== typeof this.isRight ||
                    (this.isRight = e.isRightPositioned());
                ...
                if (c) {
                    ...
                    var l = parseInt(n.computedStyle(this.chatContainer.elementReferrer, "width").replace("px", ""), 10),
                        ...
                        p = 0 > p ? 0 : p;
                    this.isRight && "right" === c || !this.isRight && "left" === c ? (c = l - (p - m), 280 > c ? c = 280 : (p > this.actualViewPortWidth - c - 1 && (p = this.actualViewPortWidth - c - 1), g.style.cssText += ";" + f +
                        ":" + p + "px !important", this.startOffsetX = c)) : this.startOffsetX = c = this.isRight ? this.actualViewPortWidth - a.clientX - m : a.clientX - m;
                    280 <= c && 0 < this.actualViewPortWidth - (c + parseInt(n.computedStyle(g, f).replace("px", ""), 10)) && this.setWidth(c)
                }
                d && ("bottom" === d ? (d = parseInt(g.style.bottom.replace("px", "")), a = this.actualViewPortHeight - a.clientY, 0 > a && (a = 0), d = parseInt(n.computedStyle(this.chatContainer.elementReferrer, "height").replace("px", ""), 10) - (a - d), 330 > d ? d = 330 : (a > this.actualViewPortHeight - d - 1 && (a = this.actualViewPortHeight -
                    d - 1), g.style.cssText += ";bottom:" + a + "px !important", this.startOffsetY = d)) : (startOffsetY = parseInt(n.computedStyle(g, "bottom").replace("px", ""), 10), d = this.actualViewPortHeight - a.clientY - startOffsetY, this.startOffsetY = this.startY - startOffsetY), 330 <= d && 0 < this.actualViewPortHeight - (d + parseInt(n.computedStyle(g, "bottom").replace("px", ""), 10)) && this.setHeight(d), b.viewHandler.adjustEmojiContainerHeight());
                h && this.scrollToBottom();
                b && b.formHandler && b.formHandler.resize()
            };
            F.prototype.setChatWindowXPosition =
                function(a) {
                    ...
                    this.iframeContainer.restyle(b,
                        a + "px !important")
                };
            F.prototype.setChatWindowYPosition = function(a) {
                ...
                20 > a ? a = 0 : 20 > this.actualViewPortHeight - (a + e) && (a = this.actualViewPortHeight -
                    e);
            ...
            F.prototype.onWindowResizeTimeout = function() {
                var a = this.getActualViewportDimensions(),
                    ...
                    e = this.isBottom ? parseInt(d.style.bottom.replace("px", ""), 10) : parseInt(d.style.top.replace("px",
                        ""), 10),
                ...
                l + e > a && (e = a - l, 0 > e && (l += e, e = 0, this.setHeight(l)), this.isBottom ? d.style.bottom = e + "px" : d.style.top = e + "px");
                this.wasScrollbarDown && this.scrollToBottom();
                this.resetFrameDimensions()
            };
            F.prototype.setWidth =
                function(a) {
                    if (!a || 300 > a) a = 300;
            ...
            F.prototype.onEmbeddedWindowResize = function() {
                ...
                this.isWidgetElementDimensionsNull ? (this.setWidth(e.maximizedDimensions().width), this.setHeight(e.maximizedDimensions().height)) : (this.chatContainer.restyle("width", "100%"), this.chatContainer.restyle("height",
                    "100%"))
            };
            ...
            F.prototype.expandAgentList = function(a) {
                var b, d;
                if (d = this.chatContainer) b = d.getElementById("agentBar"),
                    d = d.getElementById("expandableLink"), 1 === a.button && !g.event || 1 < a.button || (-1 === b.className.indexOf("expanded") ? (b.className += " expanded", d.className = "expanded") : (b.className = b.className.replace("expanded", ""), d.className = ""), this.styleAgentBar())
            };
            F.prototype.resetView = function() {
                var a, b, d, e, f;
                if (e = this.chatContainer) a = e.getElementById("chatWrapper"), d = e.getElementById("agentList"), f = e.getElementById("agentBar"), e = e.getElementById("expandableLink"), a && (b = a.lastChild, a.innerHTML = "", a.appendChild(b)),
                    d && (d.innerHTML = ""), f && (a = f.parentNode.childNodes[0], f.className = "", a && -1 !== a.className.indexOf("agentWrapper") && a.parentNode.removeChild(a)), e && (e.style.visibility = "hidden", e.className = ""), this.show()
            };
            ...
            var hb = F.extend({
                    ...
                    changeDragElementSize: function(a) {
                        this.dragElement.restyle(e.isRTL() ?
                            "right" : "left", a + "px !important")
                    },
                    handleEndChat: function() {
                ...
                ia = function() {
                    ...
                    e.isCenterPositioned() && "rectangle" === e.mobileWidget() && (e.isRightPositioned() ? (c.transform = "rotate(-90deg)", c.right = "0px") : (c.left = "0px", c.transform = "rotate(90deg)"));
                    this.container = new Q(n.getRandomName(), n.getGenericStyle(c),
                        ba, "iframe");
                    r.pageStatus.subscribe(function(b) {
                        a.updateStatus(b)
                    });
            ...
            ia.prototype.setDimensions = function() {
                "rectangle" ===
                e.mobileWidget() ? (this.minifiedBoxWidth = 110, this.minifiedBoxHeight = 68) : this.minifiedBoxHeight = this.minifiedBoxWidth = 60
            };
            ...
            ia.prototype.updateStatus = function(a) {
                ...
                if (this.container && a) {
                    if (c = this.container.getElementById("tawkchat-status-icon")) c.className = a;
                    if (c = this.container.getElementById("tawk-minified-mobile-text")) c.innerHTML = "online" === a || "away" === a ? b.languageParser.translate("chat", "chat_text") : b.languageParser.translate("chat",
                        "mail_text");
                    try {
                        b.eventEmitter.emit("resizeIframeHeight")
                    } catch (d) {
            ...
            ia.prototype.attachEvents = function() {
                ...
                this.container.attachUserEventListener("touchmove",
                    function() {
                        a.isMoving = !0
            ...
            ia.prototype.updateWidgetPosition = function() {
                var a = "";
                this.container && this.container.elementReferrer && (a = e.isCenterPositioned() ? a + " center " : e.isTopPositioned() ? a + " top " : a + " bottom ", a = e.isRightPositioned() ? a + " right " : a + " left ", a += " " + e.mobileWidget() + " ", this.container.documentRef.body.className = a)
            };
            ...
            A.prototype = new z;
            A.prototype.constructor = A;
            A.prototype.parent = z.prototype;
            ...
            A.prototype.handleEndChat = function() {
                f.chatEnded();
            ...
            A.prototype.hideWidget = function() {
            ...
            A.prototype.showWidget = function() {
            ...
            A.prototype.addResizeEvents = function(a) {
                var c, d = this;
                c = function(a) {
                    d.resizeHandler()
                };
            ...
            A.prototype.checkMetaContent = function() {
                var a, b = {},
                    d = this.metaContent;
                if (d) {
            ...
            A.prototype.ifScrollbarDown = function() {
            ...
            A.prototype.getMetaContent = function() {
            ...
            A.prototype.resizeMobileRectangleWidget = function() {
                ...
                "rectangle" === e.mobileWidget() && (a.style.width = "", this.minifiedBoxWidth = a.offsetWidth + 30, 110 > this.minifiedBoxWidth ? this.minifiedBoxWidth = 110 : !this.isLandscape() && this.minifiedBoxWidth > screen.width ? (this.minifiedBoxWidth = screen.width - 30, a.style.width = "calc(100% - 30px)") : this.isLandscape() && this.minifiedBoxWidth >
                    f && (this.minifiedBoxWidth = f - 30, a.style.width = "calc(100% - 30px)"), !this.isLandscape() && this.minifiedBoxWidth > screen.width - 30 ? this.minifiedBoxWidth = screen.width - 30 : this.isLandscape() && this.minifiedBoxWidth > f - 30 && (this.minifiedBoxWidth = f - 30 - 10), d.style.width = this.minifiedBoxWidth + "px", e.isRTL() ? b.style.right = this.minifiedBoxWidth - 17 + "px" : b.style.left = this.minifiedBoxWidth - 17 + "px")
            };
            A.prototype.scaleContent = function(a) {
                if (!this.isMaximized) {
                    ...
                    a && g && (d = Math.ceil(d * a) + 30, f = Math.ceil(f * a) + 10, this.minifiedWidget.container.massRestyle({
                        height: d +
                            "px !important",
            ...
            A.prototype.renderBottomWidget = function() {
            ...
            A.prototype.handleIndicatorToggle = function(a) {
                ...
                e.className =
                    a ? e.className + " indicator-on " : e.className.replace("indicator-on", "");
            ...
            A.prototype.updateViewByStatus = function(a, b) {
            ...
            A.prototype.updateWidgetPosition = function(a) {
                var b = {},
                    d = {};
                a = a || this.minifiedBoxHeight;
                this.iframeContainer && (e.isCenterPositioned() ? (b.top = "50% !important", b.bottom = "auto !important", b.margin = this.isMinifiedRound ? -0.5 * a + "px 0 0 0 !important" : -0.5 * a - (this.defaultHeight - 37) / 2 + "px 0 0 0 !important") : (b.margin = "0 !important", e.isTopPositioned() ? (b.top = "0px !important", b.bottom = "auto !important", d.top = this.isMinifiedRound ? "20px !important" : "-10px !important") : (b.bottom = "0px !important", b.top = "auto !important", d.bottom = this.isMinifiedRound ? "14px !important" :
                    "0px !important")), e.isRightPositioned() ? (b.right = "0px !important", b.left = "auto !important", d.right = this.isMinifiedRound ? "20px !important" : "15px !important") : (b.left = "0px !important", b.right = "auto !important", d.left = this.isMinifiedRound ? "20px !important" : "15px !important"), this.iframeContainer.massRestyle(b), this.minifiedWidget.container.massRestyle(d))
            };
            A.prototype.addOverflowScroll = function(a) {
                var c = 0,
                    d = this;
            ...
            A.prototype.resetView = function() {
                var a, b;
            ...
            A.prototype.renderAgentMinimizedWidget = function(a) {
            ...
            A.prototype.handleRestartChat = function() {
                b.formHandler.closeForm();
                f.chatStarted()
            };
            A.prototype.toggleWidget = function() {
            ...
            A.prototype.isWidgetHidden = function() {
                return !this.iframeContainer.isVisible
            };
            var Ga = function(a) {
                A.call(this, a)
            ...
            var la = z.extend({
                init: function() {
                    ...
                    e.maxStyle.subscribe(function() {
                        f && f.container.elementReferrer && f.container.insertCssFile(e.maxStyle(), !0)
                    });
                    b.chatHandler.hasChatStarted.subscribe(function(a) {
                        f.toggleEndChatOption(a)
                    })
                ...
                updateViewByStatus: function(a) {
                    this._super(a);
                    f && ("preChatForm" !== b.formHandler.currentForm && "offlineForm" !== b.formHandler.currentForm) &&
                        e.isPopup && (a = m.getShortMessage(a), document.title = a ? L.pageName() + " - " + n.rawDecode(a) : L.pageName())
                },
                handleEndChat: function() {
                    f.chatEnded();
                    this.hideWidget()
            ...
            ya.prototype.setupListeners = function() {
                y ? (b.eventHandler.listen(b.viewHandler.chatContainer.documentRef, "touchmove", this.onActivityHandler, "acmmousemove"), b.eventHandler.listen(b.viewHandler.chatContainer.documentRef,
                    b.viewHandler.clickEvent, this.onActivityHandler, "acmclick"), b.eventHandler.listen(b.viewHandler.chatContainer.documentRef, "keydown", this.onActivityHandler, "acmkeydown"), b.eventHandler.listen(document, "touchmove", this.onActivityHandler, "acmousemove"), b.eventHandler.listen(document, b.viewHandler.clickEvent, this.onActivityHandler, "acclick"), b.eventHandler.listen(document, "keydown", this.onActivityHandler, "ackeydown")) : e.isPopup ? (document.onfocusin ? (b.eventHandler.listen(document, "focusin", this.popupOnFocusHandler,
            ...
            ma.prototype.setup = function() {
                ...
                e.schedule ? (this.utcOffset = -1 * ((new Date).getTime() - e.scheduleTimezone.utc), this.calculate()) : r.pageStatus(this.originalPageStatus)
            };
            ...
            Z.prototype.prepareData = function() {
                ...
                if (b) {
                    ...
                    if (-900 > d || 900 < d) d = 0;
                    this.registerData ? (this.registerData.k = c, this.registerData.d = g) : (f = b.browserData.getReferredSearchEngine(), this.registerData = {
                        a: L.pageId || "",
                        k: c,
                        w: e.widgetId,
                        d: g,
            ...
            Z.prototype.startRegister = function() {
                ...
                !a || 1E3 < (new Date).getTime() - (new Date(a)).getTime() ?
                    (ea.setHTTPCookie("TawkConnectionTime", (new Date).getTime(), !0), this.connectionCookieInterval = setInterval(function() {
            ...
            Z.prototype.doRegister = function() {
                ...
                this.previousRegisterCall = Na.xhrRequest(a, this.registerData, function(a, e) {
            ...
            na.prototype.processSettings = function(a) {
                ...
                if (!(a.wv < e.widgetVersion)) {
                    ...
                    "full" === a.dw ? (e.widgetOffsetX = 10, e.widgetOffsetY = 0) : (e.widgetOffsetX = 20, e.widgetOffsetY = 20);
                    ...
                    e.visitorTextColor = a.thm.vBblTx || "#33333";
                    e.minimizedDimensions({
                        width: c,
                        height: d
                    });
                    ...
                    b && (c = ".theme-background-color{background-color: " + e.headerBgColor + ";}", d = ".theme-text-color{color: " + e.headerTxtColor + ";}", e.showEmoji() && (g += 30), e.showRating() && (g += 30), e.showUploads() && (g += 30), b.MinifiedStyle && (f = e.topCorner + "px " + e.topCorner + "px " + e.bottomCorner + "px " + e.bottomCorner + "px !important;", messagePreviewRadius = e.topCorner + "px " + e.topCorner + "px " + e.topCorner + "px " + e.topCorner + "px !important;", bottomBorderRadius = ".bottom-border-corner{border-bottom-left-radius:" +
                        e.bottomCorner + "px !important; border-bottom-right-radius:" + e.bottomCorner + "px !important;}", topBorderRadius = ".top-border-corner{border-top-left-radius:" + e.topCorner + "px !important; border-top-right-radius:" + e.topCorner + "px !important;}", l = l + c + d, l += ".border-corner{border-radius : " + f + "-moz-border-radius : " + f + "-webkit-border-radius : " + f + "}", l += topBorderRadius, l += bottomBorderRadius, l += "#tooLongMsgNotification {background-color: " + e.headerBgColor + "; color : " + e.headerTxtColor + "}", l += "#file-upload-drop-icon {color:" +
                        e.headerBgColor + ";}", l += "#tawkchat-status-container{left: 10px;}", l += "#short-message, #maximizeChat, #minimizeChatMinifiedBtn{line-height: " + e.minimizedDimensions().height + "px;}", l += ".bubble-text-color{color:" + (e.chatBubble() ? e.chatBubble().fgc : "#ffffff") + ";}", l += "#tawkchat-message-preview-messages-container .messageBody {background-color: #fff !important; color : #333 !important;}", l += "#textareaContainer.additionalPadding{padding-right: " + g + "px;}", l += ".rtl-direction #textareaContainer.additionalPadding{padding-left: " +
                        g + "px;padding-right: 14px;}", e.minStyle(l), b.MinifiedStyle += " " + b.CommonStyle), b.MaximizedStyle && (c = ".theme-background-color{background-color: " + e.headerBgColor + ";}", d = ".theme-text-color{color: " + e.headerTxtColor + ";}", h = h + c + d, h += "#tooLongMsgNotification {background-color: " + e.headerBgColor + "; color : " + e.headerTxtColor + "}", h += "#file-upload-drop-icon {color:" + e.headerBgColor + ";}", h += "#chatMenuControls li:hover {background-color: " + e.headerBgColor + ";color: " + e.headerTxtColor + "}", h += "#formContainer>#emailTranscriptForm .form-header-icon, #changeNameForm .form-header-icon, #chatEndedForm .form-header-icon, #preChatForm .longFormContainer .form-header-icon {background-color:" +
            ...
            X.prototype.load = function() {
                ...
                "undefined" !== typeof L.pageId && "undefined" !== typeof e.widgetId && (m.processSettings(u.widgetSettings), this.init(), this.isDocumentReady || (b.eventHandler.listen(document, "DOMContentLoaded", function() {
                    a.init()
            ...
            X.prototype.init = function() {
                ...
                if ("XMLHttpRequest" in g && "withCredentials" in new XMLHttpRequest && (x.cookieEnabled && !this.isDocumentReady) && (this.isDocumentReady = !0, c =
                    ...
                    y ? (e.isPopup ? b.viewHandler = new la : this.initRenderer(y), b.formHandler = new M) : (b.formHandler = new M, b.viewHandler = new hb, b.audioPlayer.initAudioPlayer());
                    b.viewHandler && (b.sessionHandler.setVisitorAttributes(), l.triggerApiHandlers("onBeforeLoad"),
                        this.bootStrap())
                }
            };
            ...
            X.prototype.extractRegisterData = function(a) {
                a.wdgt && (a.wdgt.lc !== u.widgetSettings.lc && (this.waitingForLanguage = !0, n.insertScript("https://static-v.tawk.to/677/languages/" + a.wdgt.lc + ".js")), m.processSettings(a.wdgt));
